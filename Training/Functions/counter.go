...
func main() {
	...
	ptr := &increment
	fmt.Println(ptr)         // ячейка стека, где лежит функция func() int - ячейка стека
	fmt.Println(&increment)  // тоже ячейка стека, где лежит функция func() int - ячейка стека
	fmt.Println(*ptr)        // ячейка кучи, где лежит переменная ptr, переменные функций и ссылочные типы хранятся в куче, недолговечные элементы - в стеке.
	fmt.Println(increment)   // ячейка кучи, где лежит переменная ptr
